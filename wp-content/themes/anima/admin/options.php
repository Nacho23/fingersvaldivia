...
'sections' => array(
	...
	array('id'=>'anima_headertitles', 'title'=>__('Header Titles','anima'), 'callback'=>'', 'sid'=> 'anima_post_section'),
...
'options' => array (
	...
	'id' => 'anima_headerresponsive',
		'type' => 'select',
		'values' => array( 0, 1 ),
		'labels' => array( __("Cropped","anima"), __("Responsive","anima") ),
	...
	'id' => 'anima_lptexttwo',
		'type' => 'select',
		'label' => sprintf( __('Text Area %n','anima'), 2),
		'values' => cryout_pages_for_customizer(1, __('Disabled', 'anima') ),
		'labels' => cryout_pages_for_customizer(2, __('Disabled', 'anima') ),
		'desc' => '',
	'section' => 'anima_lptexts' ),
	...
	'id' => 'anima_lptextthree',
		'type' => 'select',
		'label' => sprintf( __('Text Area %n','anima'), 3),
		'values' => cryout_pages_for_customizer(1, __('Disabled', 'anima') ),
		'labels' => cryout_pages_for_customizer(2, __('Disabled', 'anima') ),
		'desc' => '',
	'section' => 'anima_lptexts' ),
	...
	'id' => 'anima_lptextfour',
		'type' => 'select',
		'label' => sprintf( __('Text Area %n','anima'), 4),
		'values' => cryout_pages_for_customizer(1, __('Disabled', 'anima') ),
		'labels' => cryout_pages_for_customizer(2, __('Disabled', 'anima') ),
	...
	'id' => 'anima_fgeneralweight',
		...
		'labels' => array( __('300 (ligher)','anima'), __('400 (normal)','anima'), __('700 (bold)','anima'), __('800 (bolder)','anima') ),
		'desc' => '',
	'section' => 'anima_fontfamily' ),
	array(
	'id' => 'anima_fgeneral',
...
array(
	...
	'id' => 'anima_fresponsive',
		...
		'desc' => __("<strong>Responsive</strong> will scale depending on the viewed resolution<br><strong>Cropped</strong> will always have the configured height.","anima"),
	'section' => 'anima_featured' ),
	array(
	'id' => 'anima_falign',
		'type' => 'select',
